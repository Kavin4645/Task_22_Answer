...
public class Ans_1 {
	...
	public static void main(String[] args) throws Exception {
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(By.name("first_name"))).sendKeys("Test");
		wait.until(ExpectedConditions.presenceOfElementLocated(By.name("last_name"))).sendKeys("Miller");
		wait.until(ExpectedConditions.presenceOfElementLocated(By.name("business_name"))).sendKeys("Tester");
		wait.until(ExpectedConditions.presenceOfElementLocated(By.name("email"))).sendKeys("testmiller03@gmail.com");
